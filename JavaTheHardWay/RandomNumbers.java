public class RandomNumbers {
  public static void main(String[] args){
    ...
    rps = Math.random();
    if (rps < 0.3333333) {// this will be true 1/3 of the time
    ...
    //pick four randon integers, each 1-10
    ...
    // display three random integers from 1 -3
    a = 1 + (int)( 2*Math.random() );
    b = 1 + (int)( 2*Math.random() );
    c = 1 + (int)( 2*Math.random() );
    System.out.println("1-3:\t" + a + "\t" + b + "\t" + c );

    // display three random integers from 5-10
    a = 4 + (int)( 6*Math.random() );
    b = 4 + (int)( 6*Math.random() );
    c = 4 + (int)( 6*Math.random() );
    System.out.println("1-3:\t" + a + "\t" + b + "\t" + c );
